...
(function() {
  ...
  window.Board = Backbone.Model.extend({
    ...
    _getFirstRowColumnIndexForMajorDiagonalOn: function(rowIndex, colIndex) { // ( 0, 1) = 1 (1, 2) = 1
 ...
 */
    ...
    hasAnyRowConflicts: function() {
      var rowIndex = 0;
      while (0 <= rowIndex && rowIndex < this.get('n')) {
    ...
    hasAnyColConflicts: function() {
      var colIndex = 0;
      while (0 <= colIndex && colIndex < this.get('n')) {
...
*/
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) { //_getFirstRowColumnIndexForMajorDiagonalOn
      var counter = 0;
      var rowIndex = 0;
      var colIndex = 0;
